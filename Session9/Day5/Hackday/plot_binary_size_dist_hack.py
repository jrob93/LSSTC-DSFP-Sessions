'''
plot the mass distribution for binary systems.

We can also look at the production rate of singles of different mass limits,
Test how many singles of mag>25 are produced by the simulation.
'''
...
for M_c in cloud_masses:
    print M_c,numpy.mean(m_mag[M_cloud==M_c])
